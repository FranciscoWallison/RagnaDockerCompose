...
cp -v ../../../serve/emulador/sql-files/item_db_re_etc.sql ../../../db/sql-files/item_db_re_etc.sql
cp -v ../../../serve/emulador/sql-files/mob_db2.sql ../../../db/sql-files/mob_db2.sql
cp -v ../../../serve/emulador/sql-files/mob_db2_re.sql ../../../db/sql-files/mob_db2_re.sql
cp -v ../../../serve/emulador/sql-files/item_cash_db2.sql ../../../db/sql-files/item_cash_db2.sql
cp -v ../../../serve/emulador/sql-files/item_db_re_usable.sql ../../../db/sql-files/item_db_re_usable.sql
cp -v ../../../serve/emulador/sql-files/mob_skill_db.sql ../../../db/sql-files/mob_skill_db.sql
cp -v ../../../serve/emulador/sql-files/mob_skill_db_re.sql ../../../db/sql-files/mob_skill_db_re.sql
cp -v ../../../serve/emulador/sql-files/item_db.sql ../../../db/sql-files/item_db.sql
cp -v ../../../serve/emulador/sql-files/item_db_re.sql ../../../db/sql-files/item_db_re.sql
...
cp -v ../../../serve/emulador/sql-files/mob_skill_db2_re.sql ../../../db/sql-files/mob_skill_db2_re.sql
cp -v ../../../serve/emulador/sql-files/item_db2.sql ../../../db/sql-files/item_db2.sql
cp -v ../../../serve/emulador/sql-files/item_db2_re.sql ../../../db/sql-files/item_db2_re.sql
...
cp -v ../../../serve/emulador/sql-files/item_db_re_equip.sql ../../../db/sql-files/item_db_re_equip.sql
cp -v ../../../serve/emulador/sql-files/mob_db.sql ../../../db/sql-files/mob_db.sql
cp -v ../../../serve/emulador/sql-files/mob_db_re.sql ../../../db/sql-files/mob_db_re.sql
echo "finish copy"
